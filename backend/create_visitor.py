...
def create_test_visitor():
    try:
        ...
        existing_visitor = Visitor.query.filter_by(email="visitante@ejemplo.com").first()
        
        if existing_visitor:
            print(f"El visitante con email visitante@ejemplo.com ya existe (ID: {existing_visitor.id})")
